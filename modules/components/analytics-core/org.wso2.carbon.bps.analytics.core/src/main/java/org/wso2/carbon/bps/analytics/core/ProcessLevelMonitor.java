...
import org.wso2.carbon.bps.analytics.core.clients.AnalyticsRestClient;
import org.wso2.carbon.bps.analytics.core.models.AggregateField;
import org.wso2.carbon.bps.analytics.core.models.AggregateQuery;
import org.wso2.carbon.bps.analytics.core.models.SearchQuery;
import org.wso2.carbon.bps.analytics.core.utils.Helper;
...
public class ProcessLevelMonitor {
	...
	public String getAvgExecuteTimeVsProcessId() {
		...
		query.setQuery(Helper.getDateRangeQuery(AnalyticConstants.COLUMN_FINISHED_TIME, 1452623400000l, 1452709800000l));
		query.setAggregateFields(aggregateFields);
